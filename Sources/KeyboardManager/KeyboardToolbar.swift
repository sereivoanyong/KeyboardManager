...
final public class KeyboardToolbar: UIToolbar {
  ...
  public override init(frame: CGRect) {
    ...
    if #available(iOS 13.0, *) {
      ...
      titleLabel.textColor = UIColor(red: 0.23529411764705882, green: 0.23529411764705882, blue: 0.2627450980392157, alpha: 0.3)
    }
...
private let keyboardUpImage: UIImage = {
  ...
  // Support for RTL languages like Arabic, Persia etc...
  return UIImage(data: data, scale: 3)!.imageFlippedForRightToLeftLayoutDirection()
}()

private let keyboardDownImage: UIImage = {
